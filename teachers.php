                ...
                <div class="modal-body">
                    <div class="panel-body">
                        <div class="col-md-6">
                            ...
                            <div class="form-group ">
                                <div class="col-md-12 col-xs-12">
                                    <input data-toggle="tooltip" data-placement="bottom" title="Original" type="text" class="form-control" name="original" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h5 class="push-up-1">Permanency</h5>
                            <div class="form-group ">
                                <div class="col-md-12 col-xs-12">
                                    <input data-toggle="tooltip" data-placement="bottom" title="Permanency" type="text" class="form-control" name="permanency" required/>
                                </div>
                            </div>
                            <h5 class="push-up-1">Latest</h5>
                            <div class="form-group ">
                                <div class="col-md-12 col-xs-12">
                                    <input data-toggle="tooltip" data-placement="bottom" title="Latest" type="text" class="form-control" name="latest" required/>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group ">
                                    <div class="col-md-12 col-xs-12">
                                        <input data-toggle="tooltip" data-placement="bottom" title="Original" type="text" class="form-control" name="original" value="<?php echo $fetch['teacher_original']?>" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group ">
                                    <div class="col-md-12 col-xs-12">
                                        <input data-toggle="tooltip" data-placement="bottom" title="Permanency" type="text" class="form-control" name="permanency" value="<?php echo $fetch['teacher_permanency']?>" required/>
                                    </div>
                                </div>
                                <h5 class="push-up-1">Latest</h5>
                                <div class="form-group ">
                                    <div class="col-md-12 col-xs-12">
                                        <input data-toggle="tooltip" data-placement="bottom" title="Latest" type="text" class="form-control" name="latest" value="<?php echo $fetch['teacher_latest']?>" required/>
                                    </div>
                                </div>
                                <h5 class="push-up-1">Position</h5>
                                <div class="form-group ">
