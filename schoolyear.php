                            ...
                            <div class="panel panel-primary">
                                <div class="panel-heading">                                
                                    ...
                                    <div class="btn-group pull-right">
                                        <div class="pull-left">
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#newyear">Add School Year</button>
                                        </div>
                                    </div>                                
                                </div>
                                <div class="panel-body">
                                    <table class="table datatable">
                                        ...
                                        <tbody>
                                            <?php
    require 'connection.php';
            $query = $conn->query("SELECT * FROM `schoolyear` ORDER BY `entry_id` DESC") or die(mysqli_error());
            while($fetch = $query->fetch_array()){
                                            ?>                                      
                                            <tr>
                                                <td><?php echo $fetch['entry_id']?></td>
                                                <td><?php echo $fetch['school_year']?></td>
                                                <td><center>
                                                    <a href="viewschoolyear.php?id=<?php echo $fetch['entry_id']?>&school_year=<?php echo $fetch['school_year']?>" class="btn btn-primary btn-sm">View School Year</a>
                                                    </tr>
                                                    <?php
            }
            $conn->close();
        ...
        <!-- Add Principal -->
        <div class="modal fade" id="newyear" tabindex="-1" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
            <div class="modal-dialog modal-sm">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title" id="smallModalHead">Add New School Year</h4>
                    </div>
                    <form role="form" id="principalform" class="form-horizontal" action="crud/addschoolyear.php" method="post" onsubmit="return confirm('Are you sure you want to add this new school year?');" >
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-primary" name="addyear"><span class="fa fa-check"></span>Save</button> 
