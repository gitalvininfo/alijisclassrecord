...
if(ISSET($_POST['editteacher'])){
    ...
    `teacher_bday` = '$birthdate', `teacher_tin` = '$tin', `teacher_original` = '$original', `teacher_permanency` = '$permanency',
    `teacher_latest` = '$latest', `teacher_position` = '$position', `teacher_plantilla` = '$plantilla', `teacher_bp` = '$bp',
