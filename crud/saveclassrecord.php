...
if(ISSET($_POST['submit'])){
    ...
    if(checkscore($schoolyear,$teacherid,$subject,'w1') == false){
    foreach(array_combine($name,$w1) as $new => $value){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w2') == false){
    foreach(array_combine($name,$w2) as $new => $value){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w3') == false){
    ...
    if(checkscore($schoolyear,$teacherid,$subject,'w4') == false){  
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w5') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w6') == false){     
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w7') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w8') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w9') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'w10') == false){
...
////========================female
    if(checkscore($schoolyear,$teacherid,$subject,'gw1') == false){
    foreach(array_combine($gname,$gw1) as $new => $value){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw2') == false){
    foreach(array_combine($gname,$gw2) as $new => $value){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw3') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw4') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw5') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw6') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw7') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw8') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw9') == false){
     ...
     if(checkscore($schoolyear,$teacherid,$subject,'gw10') == false){
